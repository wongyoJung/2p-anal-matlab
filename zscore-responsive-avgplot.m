...
%     zscore_norm = zscore/max(abs(zscore));
    ...
    res_zscore = mean(zscore(1501:4501));
    m = res_zscore;
...
newColors = [inh_color; act_color;no_res_color];
...
%% avg plot
avgplot(clust_inh,[0/255 86/255 191/255],300);
avgplot(clust_act,[255/255, 73/255, 56/255],300);
avgplot(clust_no_res,[0.5 0.5 0.5],300);
