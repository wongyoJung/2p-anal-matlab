function [cummulLick,countB] = cummulLickDraw_oneBottle_milli(directory,filename,animalID,liquid)
...
%     LickA=length(find(strcmp(select(1:TimeId,1),'LickA')));
    ...
    cummulLick(t/50+1,1)=t;
    cummulLick(t/50+1,2)=LickB;
