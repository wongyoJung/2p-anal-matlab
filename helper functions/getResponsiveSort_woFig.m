function [data1_clust1,data1_clust2, data1_clust3, data1_clust4,data2_clust1,data2_clust2, data2_clust3, data2_clust4 ] = getResponsiveSort_woFig(data1,data2,bef)
...
data2_clust1 = data2(clust1_idx,bef:bef+10*5*60);
data2_clust2 = data2(clust2_idx,bef:bef+10*5*60);
data2_clust3 = data2(clust3_idx,bef:bef+10*5*60);
data2_clust4 = data2(clust4_idx,bef:bef+10*5*60);
